			...
			<div class="article article--page">
				...
				<div class="article__content">
					<div class="article__artist">
						...
						<div>
							<h1>Lê Quang Trường</h1>
							<span>spt: #56488</span>
						</div>
					</div>

					<ul>
						<li>Họ & Tên: <span>Lê Quang Trường</span></li>
						<li>Email: <span>Lequangtruong@gmail.com</span></li>
						<li>Số điện thoại: <span>0388657615</span></li>
						<li>Địa chỉ: <span>5/55 Võ Trường Toản, phường 12, Quận 5, TP.HCM</span></li>
						<li>Nghề nghiệp: <span>Sinh viên</span></li>
					</ul>
